...
public class SignUtils {
    ...
    public static ArrayList<Sign> getAdjacentSignList(
            MinecartManiaMinecart minecart, int range) {
        return getAdjacentSignList(minecart.minecart.getLocation(), range);
    }
    
    public static ArrayList<Sign> getAdjacentSignList(
            MinecartManiaMinecart minecart, int range, boolean force) {
        return getAdjacentSignList(minecart.minecart.getLocation(), range, force);
    }
    
    public static ArrayList<Sign> getAdjacentSignList(Location location,
            int range) {
        return getAdjacentSignList(location.getWorld(), location.getBlockX(), location.getBlockY() - 1, location.getBlockZ(), range);
    }
    
    public static ArrayList<Sign> getAdjacentSignList(Location location,
            int range, boolean force) {
        return getAdjacentSignList(location.getWorld(), location.getBlockX(), location.getBlockY() - 1, location.getBlockZ(), range);
    }
    
    public static ArrayList<Sign> getAdjacentSignList(World w, int x, int y,
            int z, int range) {
        return getAdjacentSignList(w, x, y, z, range, false);
    }
    
    public static ArrayList<Sign> getAdjacentSignList(World w, int x, int y,
            int z, int range, boolean force) {
    ...
    public static ArrayList<com.afforess.minecartmaniacore.signs.Sign> getAdjacentMinecartManiaSignList(
    ...
    public static ArrayList<com.afforess.minecartmaniacore.signs.Sign> getAdjacentMinecartManiaSignList(
            Location location, int range, boolean force) {
    ...
    public static ArrayList<com.afforess.minecartmaniacore.signs.Sign> getMinecartManiaSignBeneathList(
            Location location, int range) {
    ...
    public static ArrayList<Sign> getParallelSignList(
    ...
    public static ArrayList<Sign> getParallelSignList(World w, int x, int y,
            int z) {
        int range = 1;
        ArrayList<Sign> signList = new ArrayList<Sign>();
        for (int dx = -(range); dx <= range; dx++) {
    ...
    public static ArrayList<Sign> getSignBeneathList(
            MinecartManiaMinecart minecart, int range) {
        return getSignBeneathList(minecart.minecart.getLocation(), range);
    }
    
    public static ArrayList<Sign> getSignBeneathList(Location location,
            int range) {
        return getSignBeneathList(location.getWorld(), location.getBlockX(), location.getBlockY() - 1, location.getBlockZ(), range);
    }
    
    public static ArrayList<Sign> getSignBeneathList(World w, int x, int y,
            int z, int range) {
        ArrayList<Sign> signList = new ArrayList<Sign>();
    ...
    public static void sortByDistance(Block block,
            List<? extends com.afforess.minecartmaniacore.signs.Sign> signs) {
        Collections.sort(signs, new SignDistanceComparator(block.getX(), block.getY(), block.getZ()));
    }
}

class SignDistanceComparator implements
        Comparator<com.afforess.minecartmaniacore.signs.Sign> {
    private int x, y, z;
    ...
    protected int getSquaredDistanceFromLocation(
            com.afforess.minecartmaniacore.signs.Sign sign) {
    ...
    public int compare(com.afforess.minecartmaniacore.signs.Sign sign1,
            com.afforess.minecartmaniacore.signs.Sign sign2) {
