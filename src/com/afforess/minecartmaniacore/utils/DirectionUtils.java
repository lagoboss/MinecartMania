...
public abstract class DirectionUtils {
    ...
    public static boolean isEqualOrNoDirection(CompassDirection e1,
            CompassDirection e2) {
    ...
    public static Block getBlockTypeAhead(World w, CompassDirection efacingDir,
            int x, int y, int z) {
        if (efacingDir == CompassDirection.NORTH)
    ...
    public static int getMinetrackRailDataForDirection(
            CompassDirection eOverrideDir, CompassDirection eFacingDir) {
        if (eFacingDir == CompassDirection.NORTH) {
    ...
    public static CompassDirection getDirectionFromString(String dir,
