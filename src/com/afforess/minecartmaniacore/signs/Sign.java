...
public interface Sign {
     ...
     *            to set at the line
     * @param update
     *            whether to update the physical state of the sign
     */
     ...
     * 
     * @param minecart
     *            to execute the actions for.
     * @param sync
     *            forces the actions to be performed on the main thread
