...
public class MinecartManiaPlayer extends MinecartManiaSingleContainer implements MinecartManiaInventory {
    ...
    public MinecartManiaPlayer(final String name) {
        super(null);
        this.name = name;
        if (isOnline()) {
    ...
    /**
     * Returns the player that this MinecartManiaPlayer represents MinecartManiaPlayer' represent a player in whatever state they are in, online or offline. Because of this, getPlayer will return null when offline.
     * 
     * @return player
     */
    ...
    public final void setLastStation(final String s) {
        lastStation = s;
    }
